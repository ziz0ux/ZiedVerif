...
def create_pdf_report(hash_id, score, verdict):
    ...
    pdf.cell(0, 10, txt="CERTIFICAT D'AUTHENTICITE GAMOUDIVERIF", ln=True, align='C')
    pdf.ln(10)
    ...
    # On utilise multi_cell pour le Hash pour éviter qu'il sorte de la page
    ...
    # LA CORRECTION : output() renvoie des bytes par défaut en ligne, 
    # et on force la conversion en bytes si nécessaire.
