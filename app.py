...
def create_pdf_report(hash_id, score, verdict):
    ...
    pdf.cell(0, 10, txt="CERTIFICAT D'AUTHENTICITE ZiedVERIF", ln=True, align='C')
    pdf.ln(10)
    ...
    pdf.ln(5)
    pdf.write(10, f"ID Unique (Hash) : {hash_id}")
    pdf.ln(15)
    ...
    # .output(dest='S') renvoie une chaîne de caractères brute qu'on encode en latin-1
